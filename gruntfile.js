...
module.exports = function (grunt) {
    ...
    var host = process.env.OPENSHIFT_NODEJS_IP || process.env.VCAP_APP_HOST || process.env.HOST || '0.0.0.0';
    var port = process.env.OPENSHIFT_NODEJS_PORT || process.env.VCAP_APP_PORT || process.env.PORT || 9000; //process.env.VCAP_APP_PORT is deprecated
